 ...
 */
AC_API_EXPORT ac_dict_iter* ac_dict_new_iter(ac_dict_ref d);
 ...
 */
AC_API_EXPORT void ac_dict_free_iter(ac_dict_iter* it);
 ...
 * @param parent Dictionary reference.
 */
AC_API_EXPORT void ac_dict_set_array(ac_dict_ref parent);
 ...
 * @param parent Dictionary reference.
 */
AC_API_EXPORT void ac_dict_set_object(ac_dict_ref parent);
 ...
 */
AC_API_EXPORT void ac_dict_set_binary(ac_dict_ref parent, const uint8_t* data, uint32_t size);
