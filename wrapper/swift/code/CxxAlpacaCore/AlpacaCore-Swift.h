...
#ifndef ALPACACORE_SWIFT_H
#define ALPACACORE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AlpacaCore",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
#undef SWIFT_SYMBOL
#endif
#define SWIFT_SYMBOL(usrValue) SWIFT_SYMBOL_MODULE_USR("AlpacaCore", usrValue)
#ifndef SWIFT_PRINTED_CORE
#define SWIFT_PRINTED_CORE
namespace swift SWIFT_PRIVATE_ATTR {
...
SWIFT_EXTERN struct swift_interop_returnStub_AlpacaCore_uint64_t_0_8_void_ptr_8_16 $s10AlpacaCore9AssetInfoC4pathSSvg(SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
// Stub struct to be used to pass/return values to/from Swift functions.
...
static SWIFT_C_INLINE_THUNK struct swift_interop_passStub_AlpacaCore_uint64_t_0_8_void_ptr_8_16 swift_interop_passDirect_AlpacaCore_uint64_t_0_8_void_ptr_8_16(const char * _Nonnull value) {
  struct swift_interop_passStub_AlpacaCore_uint64_t_0_8_void_ptr_8_16 result;
  memcpy(&result._1, value + 0, 8);
  memcpy(&result._2, value + 8, 8);
  return result;
}

SWIFT_EXTERN void $s10AlpacaCore9AssetInfoC4pathSSvs(struct swift_interop_passStub_AlpacaCore_uint64_t_0_8_void_ptr_8_16 value, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN struct swift_interop_returnStub_AlpacaCore_uint64_t_0_8_void_ptr_8_16 $s10AlpacaCore9AssetInfoC3tagSSvg(SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN void $s10AlpacaCore9AssetInfoC3tagSSvs(struct swift_interop_passStub_AlpacaCore_uint64_t_0_8_void_ptr_8_16 value, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
...
SWIFT_EXTERN void * _Nonnull $s10AlpacaCore9AssetInfoCyACSS_SStcfC(struct swift_interop_passStub_AlpacaCore_uint64_t_0_8_void_ptr_8_16 path, struct swift_interop_passStub_AlpacaCore_uint64_t_0_8_void_ptr_8_16 tag, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // init(_:_:)
SWIFT_EXTERN struct swift_interop_returnStub_AlpacaCore_uint64_t_0_8_void_ptr_8_16 $s10AlpacaCore9ModelDescC13inferenceTypeSSvg(SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN void $s10AlpacaCore9ModelDescC13inferenceTypeSSvs(struct swift_interop_passStub_AlpacaCore_uint64_t_0_8_void_ptr_8_16 value, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN struct swift_interop_returnStub_AlpacaCore_uint64_t_0_8_void_ptr_8_16 $s10AlpacaCore9ModelDescC4nameSSvg(SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN void $s10AlpacaCore9ModelDescC4nameSSvs(struct swift_interop_passStub_AlpacaCore_uint64_t_0_8_void_ptr_8_16 value, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
// Stub struct to be used to pass/return values to/from Swift functions.
...
SWIFT_EXTERN struct swift_interop_returnStub_AlpacaCore_void_ptr_0_8 $s10AlpacaCore9ModelDescC6assetsSayAA9AssetInfoCGvg(SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
// Stub struct to be used to pass/return values to/from Swift functions.
...
SWIFT_EXTERN void $s10AlpacaCore9ModelDescC6assetsSayAA9AssetInfoCGvs(struct swift_interop_passStub_AlpacaCore_void_ptr_0_8 value, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
...
SWIFT_EXTERN void * _Nonnull $s10AlpacaCore9ModelDescCyACSS_SSSayAA9AssetInfoCGtcfC(struct swift_interop_passStub_AlpacaCore_uint64_t_0_8_void_ptr_8_16 inferenceType, struct swift_interop_passStub_AlpacaCore_uint64_t_0_8_void_ptr_8_16 name, struct swift_interop_passStub_AlpacaCore_void_ptr_0_8 assets, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // init(_:_:_:)
...
public:
  ...
  SWIFT_INLINE_THUNK swift::String getPath() SWIFT_SYMBOL("s:10AlpacaCore9AssetInfoC4pathSSvp");
  SWIFT_INLINE_THUNK void setPath(const swift::String& value) SWIFT_SYMBOL("s:10AlpacaCore9AssetInfoC4pathSSvp");
  SWIFT_INLINE_THUNK swift::String getTag() SWIFT_SYMBOL("s:10AlpacaCore9AssetInfoC3tagSSvp");
  SWIFT_INLINE_THUNK void setTag(const swift::String& value) SWIFT_SYMBOL("s:10AlpacaCore9AssetInfoC3tagSSvp");
  static SWIFT_INLINE_THUNK AssetInfo init() SWIFT_SYMBOL("s:10AlpacaCore9AssetInfoCACycfc");
  static SWIFT_INLINE_THUNK AssetInfo init(const swift::String& path, const swift::String& tag) SWIFT_SYMBOL("s:10AlpacaCore9AssetInfoCyACSS_SStcfc");
protected:
...
public:
  using RefCountedClass::RefCountedClass;
  using RefCountedClass::operator=;
  SWIFT_INLINE_THUNK swift::String getInferenceType() SWIFT_SYMBOL("s:10AlpacaCore9ModelDescC13inferenceTypeSSvp");
  SWIFT_INLINE_THUNK void setInferenceType(const swift::String& value) SWIFT_SYMBOL("s:10AlpacaCore9ModelDescC13inferenceTypeSSvp");
  SWIFT_INLINE_THUNK swift::String getName() SWIFT_SYMBOL("s:10AlpacaCore9ModelDescC4nameSSvp");
  SWIFT_INLINE_THUNK void setName(const swift::String& value) SWIFT_SYMBOL("s:10AlpacaCore9ModelDescC4nameSSvp");
  SWIFT_INLINE_THUNK swift::Array<AssetInfo> getAssets() SWIFT_SYMBOL("s:10AlpacaCore9ModelDescC6assetsSayAA9AssetInfoCGvp");
  SWIFT_INLINE_THUNK void setAssets(const swift::Array<AssetInfo>& value) SWIFT_SYMBOL("s:10AlpacaCore9ModelDescC6assetsSayAA9AssetInfoCGvp");
  static SWIFT_INLINE_THUNK ModelDesc init() SWIFT_SYMBOL("s:10AlpacaCore9ModelDescCACycfc");
  static SWIFT_INLINE_THUNK ModelDesc init(const swift::String& inferenceType, const swift::String& name, const swift::Array<AssetInfo>& assets) SWIFT_SYMBOL("s:10AlpacaCore9ModelDescCyACSS_SSSayAA9AssetInfoCGtcfc");
protected:
...
namespace AlpacaCore SWIFT_PRIVATE_ATTR SWIFT_SYMBOL_MODULE("AlpacaCore") {
  ...
  SWIFT_INLINE_THUNK swift::String AssetInfo::getPath() {
...
#endif
struct FTypeAddress {
decltype(_impl::$s10AlpacaCore9AssetInfoC4pathSSvg) * func;
};
FTypeAddress *fptrptr_ = reinterpret_cast<FTypeAddress *>(vtable_ + 96 / sizeof(void *));
  ...
  SWIFT_INLINE_THUNK void AssetInfo::setPath(const swift::String& value) {
void ***selfPtr_ = reinterpret_cast<void ***>( ::swift::_impl::_impl_RefCountedClass::getOpaquePointer(*this));
#ifdef __arm64e__
void **vtable_ = ptrauth_auth_data(*selfPtr_, ptrauth_key_process_independent_data, ptrauth_blend_discriminator(selfPtr_,27361));
#else
...
#endif
struct FTypeAddress {
decltype(_impl::$s10AlpacaCore9AssetInfoC4pathSSvs) * func;
};
FTypeAddress *fptrptr_ = reinterpret_cast<FTypeAddress *>(vtable_ + 104 / sizeof(void *));
  ...
  SWIFT_INLINE_THUNK swift::String AssetInfo::getTag() {
void ***selfPtr_ = reinterpret_cast<void ***>( ::swift::_impl::_impl_RefCountedClass::getOpaquePointer(*this));
#ifdef __arm64e__
void **vtable_ = ptrauth_auth_data(*selfPtr_, ptrauth_key_process_independent_data, ptrauth_blend_discriminator(selfPtr_,27361));
#else
...
#endif
struct FTypeAddress {
decltype(_impl::$s10AlpacaCore9AssetInfoC3tagSSvg) * func;
};
FTypeAddress *fptrptr_ = reinterpret_cast<FTypeAddress *>(vtable_ + 120 / sizeof(void *));
  ...
  SWIFT_INLINE_THUNK void AssetInfo::setTag(const swift::String& value) {
void ***selfPtr_ = reinterpret_cast<void ***>( ::swift::_impl::_impl_RefCountedClass::getOpaquePointer(*this));
#ifdef __arm64e__
void **vtable_ = ptrauth_auth_data(*selfPtr_, ptrauth_key_process_independent_data, ptrauth_blend_discriminator(selfPtr_,27361));
#else
...
#endif
struct FTypeAddress {
decltype(_impl::$s10AlpacaCore9AssetInfoC3tagSSvs) * func;
};
FTypeAddress *fptrptr_ = reinterpret_cast<FTypeAddress *>(vtable_ + 128 / sizeof(void *));
  ...
  SWIFT_INLINE_THUNK AssetInfo AssetInfo::init(const swift::String& path, const swift::String& tag) {
  ...
  alignas(alignof(swift::String)) char copyBuffer_consumedParamCopy_tag[sizeof(swift::String)];
  auto &consumedParamCopy_tag = *(new(copyBuffer_consumedParamCopy_tag) swift::String(tag));
  swift::_impl::ConsumedValueStorageDestroyer<swift::String> storageGuard_consumedParamCopy_tag(consumedParamCopy_tag);
  return _impl::_impl_AssetInfo::makeRetained(_impl::$s10AlpacaCore9AssetInfoCyACSS_SStcfC(_impl::swift_interop_passDirect_AlpacaCore_uint64_t_0_8_void_ptr_8_16(swift::_impl::_impl_String::getOpaquePointer(consumedParamCopy_path)), _impl::swift_interop_passDirect_AlpacaCore_uint64_t_0_8_void_ptr_8_16(swift::_impl::_impl_String::getOpaquePointer(consumedParamCopy_tag)), swift::TypeMetadataTrait<AssetInfo>::getTypeMetadata()));
  }
  SWIFT_INLINE_THUNK swift::String ModelDesc::getInferenceType() {
void ***selfPtr_ = reinterpret_cast<void ***>( ::swift::_impl::_impl_RefCountedClass::getOpaquePointer(*this));
#ifdef __arm64e__
void **vtable_ = ptrauth_auth_data(*selfPtr_, ptrauth_key_process_independent_data, ptrauth_blend_discriminator(selfPtr_,27361));
#else
...
#endif
struct FTypeAddress {
decltype(_impl::$s10AlpacaCore9ModelDescC13inferenceTypeSSvg) * func;
};
FTypeAddress *fptrptr_ = reinterpret_cast<FTypeAddress *>(vtable_ + 104 / sizeof(void *));
  return swift::_impl::_impl_String::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    _impl::swift_interop_returnDirect_AlpacaCore_uint64_t_0_8_void_ptr_8_16(result, (* fptrptr_->func)(::swift::_impl::_impl_RefCountedClass::getOpaquePointer(*this)));
  ...
  SWIFT_INLINE_THUNK void ModelDesc::setInferenceType(const swift::String& value) {
void ***selfPtr_ = reinterpret_cast<void ***>( ::swift::_impl::_impl_RefCountedClass::getOpaquePointer(*this));
#ifdef __arm64e__
void **vtable_ = ptrauth_auth_data(*selfPtr_, ptrauth_key_process_independent_data, ptrauth_blend_discriminator(selfPtr_,27361));
#else
...
#endif
struct FTypeAddress {
decltype(_impl::$s10AlpacaCore9ModelDescC13inferenceTypeSSvs) * func;
};
FTypeAddress *fptrptr_ = reinterpret_cast<FTypeAddress *>(vtable_ + 112 / sizeof(void *));
  ...
  SWIFT_INLINE_THUNK swift::String ModelDesc::getName() {
void ***selfPtr_ = reinterpret_cast<void ***>( ::swift::_impl::_impl_RefCountedClass::getOpaquePointer(*this));
#ifdef __arm64e__
void **vtable_ = ptrauth_auth_data(*selfPtr_, ptrauth_key_process_independent_data, ptrauth_blend_discriminator(selfPtr_,27361));
#else
...
#endif
struct FTypeAddress {
decltype(_impl::$s10AlpacaCore9ModelDescC4nameSSvg) * func;
};
FTypeAddress *fptrptr_ = reinterpret_cast<FTypeAddress *>(vtable_ + 128 / sizeof(void *));
  return swift::_impl::_impl_String::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    _impl::swift_interop_returnDirect_AlpacaCore_uint64_t_0_8_void_ptr_8_16(result, (* fptrptr_->func)(::swift::_impl::_impl_RefCountedClass::getOpaquePointer(*this)));
  ...
  SWIFT_INLINE_THUNK void ModelDesc::setName(const swift::String& value) {
void ***selfPtr_ = reinterpret_cast<void ***>( ::swift::_impl::_impl_RefCountedClass::getOpaquePointer(*this));
#ifdef __arm64e__
void **vtable_ = ptrauth_auth_data(*selfPtr_, ptrauth_key_process_independent_data, ptrauth_blend_discriminator(selfPtr_,27361));
#else
...
#endif
struct FTypeAddress {
decltype(_impl::$s10AlpacaCore9ModelDescC4nameSSvs) * func;
};
FTypeAddress *fptrptr_ = reinterpret_cast<FTypeAddress *>(vtable_ + 136 / sizeof(void *));
  ...
  SWIFT_INLINE_THUNK swift::Array<AssetInfo> ModelDesc::getAssets() {
void ***selfPtr_ = reinterpret_cast<void ***>( ::swift::_impl::_impl_RefCountedClass::getOpaquePointer(*this));
#ifdef __arm64e__
void **vtable_ = ptrauth_auth_data(*selfPtr_, ptrauth_key_process_independent_data, ptrauth_blend_discriminator(selfPtr_,27361));
#else
...
#endif
struct FTypeAddress {
decltype(_impl::$s10AlpacaCore9ModelDescC6assetsSayAA9AssetInfoCGvg) * func;
};
FTypeAddress *fptrptr_ = reinterpret_cast<FTypeAddress *>(vtable_ + 152 / sizeof(void *));
  ...
  SWIFT_INLINE_THUNK void ModelDesc::setAssets(const swift::Array<AssetInfo>& value) {
void ***selfPtr_ = reinterpret_cast<void ***>( ::swift::_impl::_impl_RefCountedClass::getOpaquePointer(*this));
#ifdef __arm64e__
void **vtable_ = ptrauth_auth_data(*selfPtr_, ptrauth_key_process_independent_data, ptrauth_blend_discriminator(selfPtr_,27361));
#else
...
#endif
struct FTypeAddress {
decltype(_impl::$s10AlpacaCore9ModelDescC6assetsSayAA9AssetInfoCGvs) * func;
};
FTypeAddress *fptrptr_ = reinterpret_cast<FTypeAddress *>(vtable_ + 160 / sizeof(void *));
  ...
  SWIFT_INLINE_THUNK ModelDesc ModelDesc::init(const swift::String& inferenceType, const swift::String& name, const swift::Array<AssetInfo>& assets) {
  alignas(alignof(swift::String)) char copyBuffer_consumedParamCopy_inferenceType[sizeof(swift::String)];
  auto &consumedParamCopy_inferenceType = *(new(copyBuffer_consumedParamCopy_inferenceType) swift::String(inferenceType));
  swift::_impl::ConsumedValueStorageDestroyer<swift::String> storageGuard_consumedParamCopy_inferenceType(consumedParamCopy_inferenceType);
  ...
  alignas(alignof(swift::Array<AssetInfo>)) char copyBuffer_consumedParamCopy_assets[sizeof(swift::Array<AssetInfo>)];
  auto &consumedParamCopy_assets = *(new(copyBuffer_consumedParamCopy_assets) swift::Array<AssetInfo>(assets));
  swift::_impl::ConsumedValueStorageDestroyer<swift::Array<AssetInfo>> storageGuard_consumedParamCopy_assets(consumedParamCopy_assets);
  return _impl::_impl_ModelDesc::makeRetained(_impl::$s10AlpacaCore9ModelDescCyACSS_SSSayAA9AssetInfoCGtcfC(_impl::swift_interop_passDirect_AlpacaCore_uint64_t_0_8_void_ptr_8_16(swift::_impl::_impl_String::getOpaquePointer(consumedParamCopy_inferenceType)), _impl::swift_interop_passDirect_AlpacaCore_uint64_t_0_8_void_ptr_8_16(swift::_impl::_impl_String::getOpaquePointer(consumedParamCopy_name)), _impl::swift_interop_passDirect_AlpacaCore_void_ptr_0_8(swift::_impl::_impl_Array<AssetInfo>::getOpaquePointer(consumedParamCopy_assets)), swift::TypeMetadataTrait<ModelDesc>::getTypeMetadata()));
  }

// Unavailable in C++: Swift global function 'translateDictToDictionary(_:)'.

// Unavailable in C++: Swift global function 'translateDictionaryToDict(_:)'.
