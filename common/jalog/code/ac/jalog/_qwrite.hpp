...
namespace ac::jalog::qwrite {
#if defined(I_AC_JALOG_TESTING_QWRITE)
...
using streambuf = astl::mem_ostreambuf<astl::small_vector<char, 1024>>;
#endif
...
AC_JALOG_API void write_float(streambuf& out, float f, float_format fmt = float_format::general, pad padding = {});
AC_JALOG_API void write_float(streambuf& out, double f, float_format fmt = float_format::general, pad padding = {});
AC_JALOG_API void write_float(streambuf& out, long double f, float_format fmt = float_format::general, pad padding = {});
