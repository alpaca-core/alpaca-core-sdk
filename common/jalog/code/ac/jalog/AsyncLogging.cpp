...
public:
    ...
    struct RemoveSink
    {
        ...
        void operator()(AsyncLoggingImpl& l)
        {
            astl::erase_all_if(l.m_sinks, [this](const SinkData& sd) { return sd.sink == sink; });
        }
    };
