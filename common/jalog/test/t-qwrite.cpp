...
#define I_AC_JALOG_TESTING_QWRITE
#include "../code/ac/jalog/_qwrite.hpp"
#include "../code/ac/jalog/_qwrite.cpp"
...
std::string wi2s(I i, ac::jalog::qwrite::pad padding = {})
{
    std::stringstream sout;

    ac::jalog::qwrite::write_integer(
        *sout.rdbuf(),
        ac::jalog::qwrite::wrapped_integer<I, Base>{i},
        padding
    );
...
{
    std::stringstream sout;
    ac::jalog::qwrite::write_float(*sout.rdbuf(), f);
    return sout.str();
}
